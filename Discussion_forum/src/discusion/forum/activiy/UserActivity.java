...
public class UserActivity {
	...
	/**
	 * This method returns all the questions that are stored in the class forum
	 *
	...
	public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
        ...
        // First if condition ensure that only admin can delete his questions, and he is also able to delete moderator's and regular user's questions also.
        ...
        // this else if condition checks whether the user is a moderator or not.
		else if(user.getUserRole() == UserRole.MODERATOR){
			//This if condition ensure that the moderator can only delete his question and regular user's question.
			if(question.getUser().getUserRole() == UserRole.USER || question.getUser() == user){
				questionService.deleteQuestion(question);
			}
			//if moderator tries to delete questions wrote by admin then else statement will be executed.
			else{
		...
		// Write else if condition to check if the user is a regular user
			...
			// this if condition checks whether the user is a regular user or not.
			if(question.getUser() == user){
				questionService.deleteQuestion(question);
			}
			//If regular user tries to delete questions wrote by moderator and admin then else statement will be executed.
			else{
				System.out.println("You are not authorised to delete this question"); 
			}
		}
